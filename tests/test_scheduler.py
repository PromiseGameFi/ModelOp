...
@pytest.mark.asyncio
async def test_scheduler_refills_slot_immediately() -> None:
    ...
    try:
        ...
        for request_id, max_new_tokens in [
            ...
            kv_tracker.try_reserve(request_id=request_id, bytes_needed=100, shed_threshold=0.99)
    ...
    assert req_3.queue_time_seconds < 0.05
    assert req_3.total_time_seconds < req_1.total_time_seconds
    assert kv_tracker.active_bytes == 0
